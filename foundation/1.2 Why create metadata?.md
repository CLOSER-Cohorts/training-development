...
## Fictional example
To start, we will look through a hypothetical example dataset and questionnaire which could have been implemented as part of a student project. The following units will then take a more detailed look into some of the terms highlighted here, which relate to creating research metadata.  
