...
[NOTE]
SW -  perhaps remove the sentence at the top as it doeasnt make sense following unit 4.4 and add some text like 'Now let’s try creating variable metadata for this example. Create a table to show which elements would you include.'
