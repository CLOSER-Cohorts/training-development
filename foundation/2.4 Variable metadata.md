...
Value representation describes how the data is represented, this could be text, numeric, date, codelist, scale, geographic, symbol. Documenting this metadata helps interpretate the data correctly in analysis.
...
Data type provides information about how the data appears in the dataset. This helps to understnad how to transform or merge datasets without errors.
...
Provenance describes where the variable data originated, how it was collected, and whether it has been transformed. Provenance information increases transparency and improves the trustworthiness and re‑usability of research data. The provenece of a variable relies on additional metadata which is provided around the variable, rather than held in the variable itself. Links can be provided to this metadata rather than duplicated here. This was briefly described in the questions and measurment unit and will be raised again in the metadata relationships unit. 

In terms of what provence is recoreded at the variable level, this may include information on any processing or derivation applied after collection. This may include...
...
The total number of records for the variable. By stating the number of cases for variable, you are able to capture the size of the datase and helps identify variables that may be  incomplete.
