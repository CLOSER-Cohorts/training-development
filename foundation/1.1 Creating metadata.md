...
Now you know you want to create metadata, how do you know what metadata to create?
...
**Using excel**<br>
In the Foundation unit, we will create metadata in an excel file using a metadata template that is available alongside this course. However, depending on your research project and the tools you chose to use, you may create and manage metadata using different software.
