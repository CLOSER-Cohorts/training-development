...
> Should we structure Foundation unit around FAIRwDDI template? Currently that template captures less metadata elements so it would slim down the content of Foundaiton <br>
