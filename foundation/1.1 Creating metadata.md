...
**Scale**<br>
If you're working on a large research project that handles a vast amount of data, you will need to create more metadata in order to effectively describe the different types of data and the processes undertaken to collect it. If it's a small research project, you may not need to include as many metadata elements.
