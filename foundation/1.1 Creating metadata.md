...
### Overview
- Recap of metadata
- How to decide what metadata create
- How to creat
...
>[!NOTE]
>SW - I wonder if we could have the 'what is metadata' to include a visual with the definition below in the middle as the definitive one and perhaps descriptions suplied by others who have done the course to give that sense of other people who have been actively taking part? We could set up a shared padlet for people to add their definitions to at a click and pick off a few to display. Just a thought. <br>
>KR I really like this idea however, I'm not sure yet what funcitonality the website software can support so will keep the note here until we decide which software we use.
...
<ul>
<li>Institutes in your working contract or project agreements
<li>Funding agencies may require metadata to ensure reusability of the data and that a project is meeting FAIR requirements</li>
<li>Journals may specify metadata as a condition for publishing</li>
<li>Supervisors may require metadaata in order to encourage data citations and enchance researcher reputation</li>
<li>By certain projects that include collaborations across agencies and/or organisations</li>
</ul>ul>
<p></p>
...
There is no singular, universally-agreed set of minimum metadata requirements. If you look on the internet, there are a variety of suggestions which are often discipline or resource specific.
...
While there is no one minimum metadata requirement, there are core metadata elements that are commonly used across disciplines. This covers high level metadata about a research project; the who, what, where, when and how of the research. Beyond this set of core metadata, what metadata you create depends on the scope and aims of your research project.  
...
<details>
<summary><mark>Sharing data: metadata considerations</mark></summary>
<p></p>
...
**Data repositories and catologues...** 
...
<ul>
<li>[CESSDA Data Model]( https://www.cessda.eu/Training/Training-Resources/Resource-crd-2592) maps out the required metadata elements needed to deposit a dataset in their data cataologue</ul>li>
<li>[UK Data Service](https://ukdataservice.ac.uk/help/deposit-data/prepare-your-data-for-deposit/) gives guidance on how to prepare your metadata and documentation</li>
</ul>
...
<details>
<summary><mark>Metadata standards and schemas</mark></summary>
<p></p>
...
<b>Using metadata standards for a large research project with shared data</b> <br>
...
<b>Using metadata standards for a small research project where data is not shared</b> <br>
...
There are also tools to help make metadata creation and management easier and more efficient. These tools can be particularly useful if you're doing a large project and need to capture extensive metadata.
...
Metadata tools can provide different different functionalities, for example: metadata management, quality review, repository compliance checkers and mapping different metadata elements. Depending on your needs, you may want to use more than one tool in your metadata management.

### Creating metadata in excel

Not inherently semantic: Excel does not express relationships or meaning between data elements (e.g., hierarchical links, controlled vocabularies).
Proprietary format: Requires specific software or libraries to interpret.
Ambiguity: Humans often add notes, merged cells, or inconsistent structures that machines struggle to interpret.
No explicit linking: Unlike RDF or XML, Excel does not natively support linking metadata elements or external identifiers.


You can also simply create metadata in an excel spreadsheet. If you're doing a small one-off project, this may be all you need. Excel is an accessible machine readable format. In excel, you can create a table to document your metadata for a research project. For example, the FAIRwDDI project offers a simple excel template and guidance to help people capture core metadata about their study. [ADD LINK TO FAIRwDDI excel template here]

However, in order to be machine
...
<p></p>
<ol>2021 Census: Public Microdata Teaching Sample (England and Wales): 1% Sample: Open Access</ol>
<ol>British Social Attitudes Survey, 2021, Health Care and Equalities: Open Access Teaching Dataset</ol>
<ol>British Social Attitudes Survey, 2019, Poverty and Welfare: Open Access Teaching Dataset</ol>
<ol>British Social Attitudes Survey, 2017, Environment and Politics: Open Access Teaching Dataset</ol>
<ol>SN 7913 Opinions and Lifestyle Survey, Well-Being Module, April-May 2015: Unrestricted Access Teaching Dataset</ol>
<ol>SN 7912 Quarterly Labour Force Survey, January - March, 2015: Unrestricted Access Teaching Dataset</ol>
<ol>SN 8011 Crime Survey for England and Wales, 2013-2014: Unrestricted Access Teaching Dataset</ol>
<ol>SN 7932 Living Costs and Food Survey, 2013: Unrestricted Access Teaching Dataset</ol>
<ol>National Survey of Sexual Attitudes and Lifestyles, 2010-2012: Open Access Teaching Dataset</ol>
<ol>SN 7140 Quarterly Labour Force Survey, January - March, 2011: Unrestricted Access Teaching Dataset</ol>
<ol>SN7146 ONS Opinions Survey, Well-Being Module, April 2011: Unrestricted Access Teaching Dataset</ol>
<ol>SN7216 Living Costs and Food Survey, 2010: Unrestricted Access Teaching Dataset</ol>
<ol>SN 6891 British Crime Survey 2007-2008: Unrestricted Access Teaching Dataset</ol>
<p></p>
...
**Based on a samll research project**
...
>[!NOTE]
> Should we tie the metadata template in this course to DDI? If so, use DDI defintion and controlled vocabularies
