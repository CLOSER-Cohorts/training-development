...
>[!NOTE]
**>NOTE for overall course <br>**
> BO - Maybe we could actually use the FAIRwDDI template? I can see the draft you've created is quite similar, but ours follows DDI rather than Dublin Core, so it might be too focused of an example? <br>
> KR Have discussed with JJ - we should keep to the current template as the it has a  <br>
...
<details>
<summary>Size of project: metadata considerations</summary>
<p></p>
...
**Using publicly available, community reviewed controlled vocabularies** <br>
