...
After exploring the metadata elements, you can practive what you've learnt using a small teaching dataset which is drawn from the 2011 Young Life and Times Survey delivered by ARK in Northern Ireland. 
...
If you would like to use an alternative teaching datasets, you find more on the UK Data Service. Expand the box below to explore more.
