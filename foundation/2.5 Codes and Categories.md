...
>[!NOTE]
> BO - should this come earlier? When I was reviewing the previous unit, I was wondering if everyone will know a code list is.

Moreover, the same code could have a different meaning in different codelists within the same datasets. For example, in the codelist for variable 's', 'M' means male, whereas 'M' in the codelist for variable 'm_s' means married.

>[!NOTE]
> BO - suggest rephrasing the above to something like "For example, "M" in the variable "s" means "male", whereas "M" in the variable "m_s" means "married", as I found the above a bit wordy.
