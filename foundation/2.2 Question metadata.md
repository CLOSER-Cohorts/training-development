...
---
>[!NOTE]
> HM add info about measurement and reorder the page

## Metadata for data collection instruments

In the previous unit, we looked at metadata to describe the what/who the data is about. Next, we will define the metadata used to describe how that data was collected.

**How might reserach data be collected?**
...
For example...
- If we record the model of the anemometer, we know the specifications and functionalities of the tool that the researcher used to collect the data which will impact the accuray, comparbiluty and interpartion of the wind measurements
