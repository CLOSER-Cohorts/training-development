...
For codelist metadata, you can map the category to the code to give the code meaning. If you're using a standardised definition for a particular category, for example, from a publicly available controlled vocabulary

| Codelist name     | Code | Category          |  Category reference            |
|-------------------|------|-------------------|--------------------------------|
| person_gender_si    | 1    | Male            |                   
| person_gender_si    | 2    | Female          |                                 
| person_gender_si     | 3    | Non-binary     |                                      
| person_gender_si    | 4    | Gender fluid    |                             
| person_gender_si    | 5    | Prefer not to answer |        
| person_gender_si     | 6    | Not specified  |            
...
Shorthand: you can input a URI/DOI to the category metadata field, pointing directly to a category definition within a controlled vocabulary. For exampl ...

| Codelist name     | Code reference            |
|-------------------|---------------------------|


Or provide longer form documentation: in addition to the category field, you add controlled vocabulary and URI. For example:

| Codelist name     | Code | Category          |  Codelist reference            |
|-------------------|------|-------------------|--------------------------------|
| person_gender_si    | 1    | Male            |                   
| person_gender_si    | 2    | Female          |                                 
| person_gender_si     | 3    | Non-binary     |                                      
