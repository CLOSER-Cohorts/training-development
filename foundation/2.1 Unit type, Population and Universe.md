...
>[!NOTE]
> BO - I'm not sure what this means "as it is the set all experimental units"?
...
>[!NOTE]
>SW re population paragraph above - not sure I understand 'the group which the units are drawn for at a specific time and place' - unless you mean 'drawn from'?
...
> BO - It's a good point! I think the level of detail that we have currently is enough for now imo.

>SW - agree with BO/ JJ and leave the more complex explanation and example for the next level
...
>[!NOTE]
>SW re sentence above I would clarify wording slightly to 'The only difference is the time frame...'
