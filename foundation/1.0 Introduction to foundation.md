...
What metadata you create and how you create it will depend on the scope, size and aim of your research. We will explore how to determine what metadata to create in the next unit. However, whenever you

should have some level of metadata to describe what the project is about and what data it contains.
