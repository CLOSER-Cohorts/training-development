...
>[NOTE]
>SW - If we decide to keep the activities at the end, I think we should add a short sentence after the last paragraph along the lines of "Now we have discusssed the different types of metadata and what to consider when creating it, the next few sections will enable you to apply your learning and create several differnt types of metadata..." 
