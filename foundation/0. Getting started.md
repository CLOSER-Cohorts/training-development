...
The training course is estimated to take about 6 hours 30 minutes to complete. This is estimated based on: - An average reading speed of 300 words per minute - Additional learning time for comprehension of technical concepts (between 20-70% added time) - Time for exercises, examples, and quizzes

>[NOTE]
>SW - bullet points may work better for the estimates above?
...
## Starting the course
If you're starting the course from the beginning, head to unit x where we'll recap what metadata is and why different types of research projects require different approaches. You may want to download all the files used in the course before you get started. Add here. If you need more of refersher, head to the Introduction to Metadata training course https://closer-cohorts.github.io/understanding-metadata/introduction/1.0%20Module%20Introduction/ first. 
