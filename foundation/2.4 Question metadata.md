...
- For codelists, we would often need more information to understand the type of data it collects, e.g. the codes in the codelists and how many codes can be selected for the question.
...
**Code list reference**
As we will unpack in the next unit (2.4 Codes and Categories), if code lists are used, we should create the necessary code list metadata. In the question metadata, we should reference the code list metadata so, if people want to, they can further understand the components of the question 
...
Like the variable metadata, we can also invlude Unit Type, Population and Universe for questions. Thinking back to the last unit, what would the Unit Type, Population and Universe be for these questions?

| Question label | Question name |Unit type             |  Population                | Universe                 |          
|---------------|---------------|-----------------------|----------------------------|----------------------------|
| Q_11          | 11            | Individual            |                            |Code list  
| Q_12          | 12            | Individual            |                            |Code list  
| Q_13          | 13            |                       | -                          |  
...
Population 
- Individuals over 16 who lived in one of the Understanding Society's sample of 32,000 households (approx) in Great Britain in 2009-10
