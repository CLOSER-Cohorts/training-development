...
>[NOTE]
>SW -  I would re-word the second sentence to make it shorter, something like 'It is valuable for us to record the information in a structured, item level way so that we can: and then bullet point from 'make decisions more systematically.../look for other opportunities for different research questions/ ensure quality...etc'
