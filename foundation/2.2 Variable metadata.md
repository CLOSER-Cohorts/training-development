...
In this way, the Universe is the larger group that the study's conclusions might apply to, based on the sample. However, while the Universe does not contextualise the Unit Type by georgaphy or time. 

For the example dataset, if the data was only collected for adults aged 18-150, the Universe would be individuals aged 18-50. This means we could compare Universe metadata from studies conducted at different times and/or locations so you can compare trends observed for adults aged 18-30.
...
However, if your dataset compiled data on different data collection points, you would specify the different Unit Type, Population and Universe for each variable.

---

| Sample ID | Crop   | Date Collected | Field ID | NDVI Score | Disease Present | Farm ID | Farm Size (ha) | Region    | Avg. Rainfall (mm) | Avg. Temp (°C) |
| --------- | ------ | -------------- | ------- | ----------- | -------------- | --------|-------------|---------------| -------------------| -------------- 
| S001      | Wheat  | 2025-06-12     | F-W01   | 0.78        | No             | Farm01  | 120         | East midlands | 55.2               | 19.1           |
| S002      | Barley | 2025-06-13     | F-B07   | 0.65        | Yes            | Farm02  | 95          | North east    | 67.4               | 17.8           |
| S003      | Corn   | 2025-06-14     | F-C03   | 0.82        | No             | Farm03  | 180         | South west    | 48.6               | 22.3           |
| S004      | Wheat  | 2025-06-15     | F-W04   | 0.73        | No             | Farm01  | 120         | West midlands | 55.2               | 19.1           |
...
[^1]: Questions taken from the 2020 survey 
