...
Variable metadata can be used to data catalogues and  repostiroies.
- Example
...
| name | label          |  Value representation | Data type   | Unit of meaurement |  Valid range  |Missing values   |
|------|----------------|-----------------------|-------------|--------------------|---------------|-----------------|
| f_n  | first name     |                       |             |                    |               |
| s    | sex            |                        
| h    | height         |                         
