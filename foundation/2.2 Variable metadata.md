...
**Data type**<br>
Data type provides further information about this data. For example, we've already described variable 'height' is numeric. However, what else could we specify about the numeric data?
...
| s    | sex            | Self-reported biological sex        | code list            | category                        
| h    | height         | Height calculated to nearest cm     | numeric              | postive integer                       
| b_d  | birthdate      | Date of birth yyyy/mm/dd            | date                 | date                          
| m_s  | martial status | Self-reported marital status        | code list            | category                          
...
**Unit of measurement**
The unit of measurement is simply the . This metadata element will not be applicable to some variables such as first name or marital status. In these cases, you can put N/A.
