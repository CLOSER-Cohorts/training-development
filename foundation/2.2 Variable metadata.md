...
Now we have looked at catalogue metadata to describe a research project and its dataset at a high level, let's take a look at metadata for the data itself (also referred to as low level metadata). This metadata describes what type of data that is included in a dataset. We will be look at creating metadata for quantitative, tabular data.
...
>[!NOTE]
>*Definition: https://rdf-vocabulary.ddialliance.org/discovery.html#variable-and-variable-definition<br>
...
If you were presented with the example dataset at the beginning of this unit, would you have the information required to understand the dataset and assess whether it is relevant to you?

If you you didn't have access to the dataset but you did receive the following information...
...
**Measurement provenance**
The measurement tool used to capture the data. For interviews, this could be the title and version of the questionnaire administered (inluding a link to the file if it is publicly available). For observations using technical equipment, it could be the make and design of the tool you used.

**Source reference**
Source reference allows you to be more specific about where the data came from. For example, if a piece of data came from a particular question within a questionnaire or derived from sepcific, you can list the Question ID or variable source here. This strengthens the provenance for your data, making your research more transparent and (re)usable.
