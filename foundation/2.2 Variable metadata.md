...
**Valid range**<br>
Valid range outlines the allowed values for this metadata element. For example, for height, you may want to set permitted values to be between 55 - 220 (depending on the population you are collecting data from).
...
Once we've described the type of data and its perameters, we can then give an overview about how the variable data appears in this dataset.
