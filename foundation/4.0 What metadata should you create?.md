...
# Unit 4.1 What metadata should you create?
...
- Do you have a data managament budget?
...
=== "Time and resources"
    If you are working on a large research project, you may have more time and resource to create metadata. Larger projects likley have dedicated budgets for data management, there could be team members with more experience of metadata, you may be required to submit formal data management plans. You could use specific metadata tools to help create and manage your metadata. If you are doing a small, solo project, you may not have the capacity to create extensive metadata or the access to metadata tools. In this scenario, it's important to prioritise the high value metadata for your research that support the aims of your project.
...
If your data has more limited scope, is exploratory, or is unlikely to be reused outside your own project, extensive metadata may be not be needed. In this case, focus on documenting the essential information needed for you to understand and manage the data may be more of a priority.
...
---
## What study metadata should you create?

## What variable metadata should you create?

Thinking back to the type of information we would need to understand the example dataset, what metadata elements could we capture to provide information about the variables? The elements marked with (R) is considered required metadata that all projects should complete. The elements marked with (O) are optional metadata that can be completed if relevant.
