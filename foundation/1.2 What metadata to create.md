...
While there is no one standard, there are common metadata elements that are often seen as fundamental to create. This is usually study level metadata: the who, what, where, when and how of the research. How you document these metadata may be defined further if you are using a particular metadata standard and/or controlled vocabulary. In the next unit, we will look at creating this metadata.
...
## Metadata for an independent research project
...
## Metadata for a research project that will be shared amongst a small group



---

## Metadata for a research project that will be shared widely 
