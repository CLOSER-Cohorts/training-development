...
## Using metadata schemas and standards to decide
Using tools such metadata schemas and standards can help define what metadata elements to create, saving you time.
