...
There is a vast range of metadata you could capture and there are many different ways you create and manage this metadata.
...
While there is no one standard, there are common metadata elements that are key in research data management. This metadata captures who, what, where, when and how of the research. How you document these metadata may be defined further if you are using a particular metadata standard and/or controlled vocabulary. In the next unit, we will look at creating this metadata.
...
**Repository requirements**
 - If you plan to deposit your research in a repository, they often specify what metadata they require. For example you can see the requirments for depositing data 
...
If you don't plan your metadata creation, you may come across these challenges:
...
## Using metadata schemas to decide what metadata to create

---

## Using metadata standards to decide what metadata to create
...
## Metadata schemas/standards and metadata creation (independent project)

Why use metadata schemas and standards even if you don't plan to share your data?

If you are conducting an independent project, you can look at the metadata elements standards require, as well as the controlled vocabularies they prescribe, in order to make sure you're creating good quality metadata. You may not have the time or need to use a full metadata standard or schema, however using one to inform you metadata creation will provide you with many benefits.
...
**Collaboration:** in larger research projects there will often be multiple people working with a dataset and managing/creating metadata. Metadata standards aids this collaborative working environment, ensuring you are all 
