...
- Produce puclication documentation that can be used for citations
...
Author(s)
- You could capture this at the begining of the data lifecycle in the Research Design phases however, you may wish to update this if more people join your research project. It is especially important that this information is correct when you come to the Publication phase.
...
Version
- You would create this metadata in you Data Collection phase however, as it records changes to data records etc. it is important this information is updated throughout the data lifecycle and beyond.
...
Unit of measurement for a variable
- This metadta can be captured in the Data Collection phase
