...
>[!NOTE]
>**BO - In the ILO's and outline, we use a mix of data management and research data management. I think we should be consistent and always use research data management?**
---
...
>[!NOTE]
>**BO -is there a difference between data management and research data management? If so, we need to say what the difference is and Which one are we focsing on, because currently we are swapping between the two and I'm not sure if they're interchangable or the same thing.**
---
