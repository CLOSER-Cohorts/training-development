...
<ul>
<li>Other people are less likely to trust and use data that is poorly managed</li>
<li>If data is hard to understand and/or hard to trust, it is unlikely it will be cited in other projects or used in secondary research and cross-study comparisons</li>
</ul>
 
<b>Research data is less secure</b>

<ul>
<li>If there is no clear data usage or sharing policies, data could be misused</li>
<li>If data is not stored in a secure location, it could be lost or accessed by people without permission</li>
</ul> 

<b>Time is wasted trying to understand data retrospectively</b>

<ul>
<li>People have to spend more time trying to find and organise poorly managed data into a meaningful structure so it can be understood and used</li>
<li>A study may need to be repeated to correct errors caused by poor data management, doubling the time and resources needed to obtain the data</li>
<li>If a study is not documented and made discoverable, people might not know it exists and it could be unnecessarily duplicated by others</li>
</ul>
...
>KR Yes, eaxctly - interested in what structure to keep "Consequences" OR "Who is impacted" as it feels like its covering the same ground
