...
Poorly managed research data doesn't just impact the person who originally creates and uses the data, it also affects other researchers after the project has finished. <p></p>
...
Poor management of data impacts the discovery, understandability and (re)use of research data. Again, reflecting on the video and your own experience, what are the consequences of this? Who does it impact?
...
>[!NOTE]
>:large_blue_diamond: KR Which structure should we keep for impacts of poor data management? I think we should only use one as it might get quite repetition. Should we use the role specific one or the thematic one?
...
The Digital Curation Centre (DCC) provide case studies of [good research data managment](https://www.dcc.ac.uk/guidance/case-studies) and [examples of DMPs alongside guidance](https://www.dcc.ac.uk/resources/data-management-plans/guidance-examples). Drawing from University case studies, they also provide tips on what to consider when implement data management plans so they're not just a document that sits on your computer, but an active approach to your research: [RDM strategy: moving from plans to action](https://www.dcc.ac.uk/sites/default/files/documents/RDM%20strategy%20development.pdf)
