...
---
## Understanding research: the specifics

As we discussed, research data profiles often give us high-level information around the research: the who, what, where, when and why.

However, if you were asked to describe what was in the dataset, would you be able to do it?

For example, if you looked at this research project, what could you tell someone about the data it collected?
...
---
## Understanding research: metadata repositories


>[!NOTE]
> Maybe we add metadata repostories here as a separate, more specific tool to data catalogue and data repositories?
