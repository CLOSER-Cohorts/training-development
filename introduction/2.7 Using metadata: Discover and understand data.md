...
>[!NOTE]
> KR Propse to move this before Controlled vocabularies so it would be unit 2.4 and then refine vocabulary unit so it doesn't repeat itself.
...
>[!NOTE]
> BO - I don't think the audience will know the difference, or even be aware of what they are, so I don't think getting them to discuss/reflect here is needed.

Let's start by defining data catalogues and data repositories.
