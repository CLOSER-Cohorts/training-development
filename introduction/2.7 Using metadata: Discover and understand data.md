...
Data catalogues and repositories will often ask research projects wishing to list or deposit their data to submit a certain level of metadata. The repository or catalogue will specify what the minimum metadata requirements are in order that the same level of information is provided for all resources and end-users of the site can use them effectively. Through standardising the level of metadata across the site, people get an even experience. We are then able to trust the data catalogue or repository to provide us with useful information as well as trust the research projects that are stored on the site. 
