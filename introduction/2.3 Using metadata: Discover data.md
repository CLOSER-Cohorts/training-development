...
**Trustworthiness**
As we explore in unit 2.2, metadata gives us provenance information that explains where the data came from and how it was collected. 
...
- Asks questions to pregnant people

Metadata helps us find studies that we may not think are relevant. For example, we might want to conduct research on preganant people's welfare. There may be a study that looks at the social attitudes and perceptions of all citizens in the UK aged 18-100. On the surface, this may not seem relevant as the scope of individuals is beyond that of preganant people and the study itself does not focus on preganancy.

However, within that there may be 

---

## Using metadata: Action

Once you have found the data, understood the research and assessed it's trustworthiness and relevance to your work, you can now decide what you want to do with it. You can act on the data.

You may want to ...
- Access the data 
- Contact a researcher or organisation involved in the project to learn more about their work
