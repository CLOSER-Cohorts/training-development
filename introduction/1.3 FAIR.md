...
- <mark>**Create metadata**</mark> that describes your project and can be readily accessed on data repositories and catalogues alongside your data (we will explore metadata in depth over the coming the units and cover metadata creation in [unit 2.6](<2.6 Creating metadata: study level.md>)
...
- Use terms that are used widely in your discipline and/or standardised by an academic community in a formal vocabulary (more information about standardisation tools such as controlled vocabularies and metadata stndards in [unit 2.3](<2.3 Using metadata: discover data.md>) and [unit 2.4](<2.4 Controlled vocabularies.md>)).
