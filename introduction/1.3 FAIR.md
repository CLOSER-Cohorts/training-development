...
- <mark>**Create rich machine-readable metadata**</mark> that describes your project and can be stored on data repositories and catalogues alongside your data (we will delve into metadata in the coming the units and cover metadata creation in unit [2.7](<2.7 Creating metadata: study level>)
...
**What you can do...**
  - Ensure your data and data documentation is clean and well structured, identifying and correcting any input or format errors
  ...
  - Use tools to standardise your data and data documentation such as controlled vocabularies, classifications, ontologies (we will explore these tools  in [unit 2.5](2.5 Controlled vocabularies))
...
- <mark>**Create rich metadata**</mark> to provide context and describe the contents of your study and its data.
