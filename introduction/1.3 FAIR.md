...
The FAIR principles provide guidance on best practice for research data management across all disciplines. The were created with the aim to improve sharing and re-use of data in research, tackling some of the challenges around research data management that we encountered in the previous unit.
...
FAIR proposes that data should be:
...
> OLD Interoperable task: Using [BARTOC's controlled vocabularies search tool](https://bartoc.org/), find the controlled vocabulary most relevant for your data
