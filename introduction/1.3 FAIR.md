...
**What you can do ...**
  - Deposit your data in an trusted repository or archive so people can find your data when searching these sites. The repository will create a Digital Object Identifier (DOI), permanent and unique link to your data that will not break.
    - [Where to keep research data - DCC guide](https://www.dcc.ac.uk/guidance/how-guides/where-keep-research-data)
