...
- <mark>**Create metadata**</mark> that describes your project and can be stored on data repositories and catalogues alongside your data (we will delve into metadata in the coming the units and cover metadata creation in unit [2.7](<2.7 Creating metadata: study level>)
...
**What you can do...**
  ...
  - <mark>**Create metadata**</mark> that complies with relevant metadata standards and schemas (we will cover metadata standards and schemas in more depth in [unit 2.6](< 2.6 Metadata standards.md>)
...
- <mark>**Create metadata**</mark> to provide context and describe the contents of your study and its data.
