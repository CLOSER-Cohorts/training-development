...
>[!NOTE]
>**BO - do we want to say "as researchers", if the audience also includes data managers?**
...
- **Create rich metadata** :triangular_flag_on_post: to provide context and content of your data
