...
The FAIR principles provide guidance on best practice for research data management across all disciplines.[1] The were created with the aim to improve sharing and re-use of data in research, tackling some of the challenges around research data management that we encountered in unit 1.2(<1.2 Research data management.md>).
