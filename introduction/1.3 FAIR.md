...
**What you can do ...**
  ...
  - <mark>**Create rich machine-readable metadata**</mark> (we will delve into metadata in the coming the units and cover metadata creation in unit [2.7](<2.7 Creating metadata: study level>))
...
**What you can do...**
  ...
  - Use the latest versions of a software (the best software for your data will depend on the data you have collected)
