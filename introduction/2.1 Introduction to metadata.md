...
Imagine you are conducting research project into XXX. You will use secondary data and will need to identify relevant datasets for your project.
...
Through answering the questions in the green bubbles, metadata can describe the research project. Metadata about the overall research project may also be referred to as high-level metadata (there is more information on the different levels of metadata in unit 2.2).
...
High-level metadata gives us a quick snapshot of what the research project is about. When we looking through 

However, what other information 
...
Through answering the blue bubbles, metadata can describe the data itself. This can be referred to as data level or item level metadata (see unit 2.2 for more information on the different levels of metadata)
...
>[!NOTE]
> once we have the data we want to use, can include examples of the study / dataset metadata for study e.g. a screenshot of the study page / table with the variable names included
...
So overall, what can metadata describe in research?

Metadata can describe ... 
 - The actual data e.g. the documents, images, datasets that make up the research
 - The concepts that our research relates to e.g. topics, research themes
 - Real-world entities involved in the research project e.g. people, organisations, locations
 - Processes conducted to complete the research e.g. data collection, processing, analysis and archiving
...
> :large_blue_diamond: KR I have tried updating the introduction but have kept it before the challenges. Does that read better?
...
Metadata allows us to maximise the potential and impact of data. With metadata, data can reach more people and enables people to use the same dataset for different purposes. 
...
Metadata is a type of data documentation, however it has several key defining features. 

Metadata is **structured documentation** that is **machine-readable** and **machine-actionable**. Let's take a look at these features.
