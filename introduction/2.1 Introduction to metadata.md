...
First, companies want people to find and buy their product. If a product isn't used . Having the good information about the product makes it more trustworthy and engaging for customers.
...
Imagine you are conducting a literature review for a research project on XXX
...
You come across this dataset. Do you think it's useful for your research project?
...
Metadata is documentation that describes the research project and its data. It gives us the context we need to understand and interpret the research project and its data so we can use in an intelligent and meaningful way.
...
Through answering the questions in the green bubbles, metadata can describe the research project.
...
Through answering the blue bubbles, metadata can describe the data itself.
...
Thinking back to the questions around the dataset, what things can metadata describe in research?

Metadata can decribe ... 
