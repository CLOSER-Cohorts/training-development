...
Description two is available online on a data catalogue site (we will cover data catalogues in more depth in unit 2.4)
...
For example, we can use computers to search and filter our metadata using sites such as data repositories and data catalogues. We'll look more closely at these in [unit 2.4](<2.4 Using metadata: discover data.md>)
