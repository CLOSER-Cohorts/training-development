...
Sometimes there are rules that dictate what values are allowed for a metadata element in order to make sure the information is clean (e.g. for the metadata element 'Date', there may be a specification to format the information as dd/mm/yyyy)
