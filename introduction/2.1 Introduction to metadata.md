...
Metadata about the overall study gives us a quick snapshot of what the research is about. This is particularly useful when we're looking through a large amount of research. It also gives us supporting information around the dataset, that may not be included in the dataset itself, for example who to contact for further information about the project.

You can find study level metadata for the mystery dataset [on this webpage.](https://discovery.closer.ac.uk/Item/uk.cls.ncds/a52ee654-efa8-4839-a545-fd82bec63e71/17)

By looking at the metadata on this webpage, we know that the research was conducted in 1969 across England, Scotland and Wales and was produced as part of the National Child Development Study. 
