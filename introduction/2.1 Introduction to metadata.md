...
## Information about how the data was collected (low level metadata)
...
- How could respondents answer? e.g. free text, multiple choice, scale 

What was the previous question?
- How many questions came before the question
- How many questions came after
- Is the question linked to another question
