...
Additionally, if the drink was stocked in shop you knew and trusted, you would be more likely to want to drink it than if you found it on the side of the road. The can would also be stocked alongside other similar  drinks so you could read the labels, compare products and make an informed decision about the drink you pick.
...
Here is the dataset again with the answers to some of the those questions.

_Study level metadata_

---

## Dataset: information about the data

Metadata can also describe the data itself.
...
Without this data, we wouldn't be able to understand the dataset easily. We would have to contact people or organisations to get further information about what the dataset is and what it conveys. 
...
## How creating metadata helps us
...
- Which description do you think is metadata?
...
We have already discussed how metadata benefits you as a researcher:
