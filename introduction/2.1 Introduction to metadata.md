...
| 4        | 1      |  4    |  4     | 4        | 1      | 1  
 ...
 >[!NOTE]
>**I can't find variable labels on CLOSER study page
...
## Challenges of having no metadata

Without this metadata, we wouldn't be able to understand the dataset easily. We would have to contact people or organisations to get further information about dataset and what it conveys. 
...
Without metadata, we have have to engage with time-consuming processes and 
