...
Having a controlled list of terms for a metadata field reduces the risk of human errors and inconsistencies, for example 'shoes' and 'shoees' and 'pale blue' and 'light blue', as you can only select a pre-defined option.

Controlled vocabularies are a publicly available list of pre-defined terms and are a type of community based standard. They are created, maintained, and updated by communities or organisations in different disciplines. The power of a controlled vocabulary increases when it becomes widely adopted. If you're currently working on a research project, look out for what controlled vocabularies your discipline community recommends. A controlled vocabulary relates to a specific discipline or area of knowledge.
