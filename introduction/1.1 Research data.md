...
So data doesn't come in one set format. Instead, there are different _representations of data_ (e.g. numbers, text, symbols, date/time etc.). By interpreting these representations, we gain meaning from the data.
