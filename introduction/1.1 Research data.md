...
In the Introduction course, we will be looking at how we can manage and document research data. Before we do this, it's important to have a strong understanding of what data is, the characteristics of data, and the role of data in research. <p></p>
...
So data doesn't come in one set format. Instead, we can say that data has different _representations_ (e.g. numbers, text, symbols, date/time etc.). By interpreting these representations, we gain meaning from the data.
...
>[!NOTE]
> BO - I don't think the second sentence (above) is needed, especially since you go on to explain the characteristics of research data in detail below, and it reads as a bit wordy/confusing to me.
...
>BO - I think you're referring to the data lifecycle here.
...
Now we have unpacked what research data is, in our next [unit 1.2](<1.2 Research data management.md>), we shall look at how we manage this research data.
