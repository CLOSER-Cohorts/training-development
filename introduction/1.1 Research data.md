...
---
## What is data?
All research projects will include data. In the Introduction course, we will be looking at how we can manage and document research data. However, in order to do this, it's important we have a strong understanding of what data is, the characteristics of data and the role of data in research.

So, we use the term data all the time, but what do we actually mean?
...
By interpreting these representations, we gain meaning from the data. In the examples above, we interpret meaning of different weather conditions.

---

## Generic definition of data

Now we've looked at the characteristics of data, how do we define the term?
...
Data relates to a **concept** that we want to study and know more about
  - In the weather conditions example this could be: 16* &rarr; temperature, London &rarr; geography, 14:00 &rarr; time
<p></p>
