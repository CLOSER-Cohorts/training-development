...
In this weather app example, we gain information about the _measurement_ of weather conditions in London by interpreting data. However, we are interpreting different types of data to do this.
...
Take cloud coverage as an example. We could gain information about cloud coverage through the following representations...
  - Number e.g. **[WHAT WOULD A NUMBER EXAMPLE BE HERE]**
  - Text e.g. 'Partially cloudy'
  - Symbols e.g. 🌥️
  - Scale e.g. 4 in Okta scale measurement (okta is a scale of measurement used to describe the amount of cloud cover on a scale between 0-8) 
...
>[!NOTE]
>KR is a 'data flow' the best way to describe this?<br>
>BO - I think it sounds fine, but I guess you're actually referring to the research lifecycle (i.e. generating a hypothesis to measure a something (something in the world), collecting data to measure >the concept (which is recorded)).<br>
>JJ - I would rephrase "What action do we need take to record it?" to be **"How was it recorded?"**<br>
...
This is how we would conceive a person's age as research data: data &rarr; measure &rarr; data flow.
...
>[!NOTE]
>SW I wonder on the figure above, should 'Has a representation' be updated to 'representation'? Or 'representation eg XYZ'
