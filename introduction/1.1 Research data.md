...
While each definition has a slightly different focus, a common theme through each definition is that data can be interpreted in order to provide information about the topic or object the data is describing.
