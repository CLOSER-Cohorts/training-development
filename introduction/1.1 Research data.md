...
<ul>
<li>Numbers e.g. 16*</li>
<li>Text e.g. 'Sunny conditions'</li>
<li>Symbols e.g. :sunny:</li>
<li>Date/Time e.g. 14:00</li>
</ul>
...
<ul>
<li>Text e.g. 'Partially cloudy'</li>
<li>Symbols e.g. 🌥️</li>
<li>Numnber e.g. 4 Oktas (okta is a scale of measurement used to describe the amount of cloud cover on a scale between 0-8)</li>
</ul>
