...
>[!NOTE]
> Should we/can we include other metadata glossaries/terminology? <p></p>
>Should this be moved to the very top of the training to cover all concepts, not just metadata concepts?

---

## Data type and metadata

The type of data you want to describe will inform what metadata can be captured.
