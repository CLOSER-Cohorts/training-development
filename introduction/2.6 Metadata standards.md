...
While controlled vocabularies standardise the content of the metadata (i.e. what's allowed to be inputted into the metadata fields), metadata schemas and standards offer a broader framework around how to structure and define metadata elements.
