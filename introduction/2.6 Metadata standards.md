...
While controlled vocabularies focus more on the content of the metadata, metadata schemas and standards offer a broader framework around how to structure and definition of metadata elements.
...
Organisations or an individual may create a schema for personal, internal or public use. A schema can be based on a metadata standard, drawing from the structure and definitions outlined in the standard. In this way, schemas can be seen as an expression of a standard. You can also get schemas which have been developed independent of a metadta standard.
...
In these examples, the studies use the DDI standard and are made available on the UK Data Service and CLOSER Discovery.
