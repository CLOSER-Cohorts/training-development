...
While controlled vocabularies standardise the content of the metadata (i.e. what's allowed to be input into the metadata fields), metadata schemas and standards offer a broader framework around how to structure and define metadata elements.
...
>[!NOTE]
>SW I would perhaps remove the term 'domain agnostic' and stick with cross- discipline so it sounds less jargon-y
...
>[!Note]
>SW -  the link to unit 2.4 in the paragraph above is not displaying as a hyperlink
...
>[!NOTE]
> BO - second bullet point is incomplete
