...
Organisations or individuals may create a schema for personal, internal or public use. A schema can be based on a metadata standard, drawing from the structure and definitions outlined in the standard. In this way, schemas can be seen as an expression of a standard. You can also get schemas which have been developed independent of a metadta standard.
