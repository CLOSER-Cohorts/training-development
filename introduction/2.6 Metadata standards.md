...
<details>
<summary><b>Three pin plug analogy</b></summary>
<p></p>
...
You know you will be able to charge your phone in any location of the UK as all three-pin plugs distributed in the UK follow a manufacturing standard. This standard means all plugs will have the correct dimensions and functionality to work with any UK socket. The details of this standard is set out by an organisation called the International Organization for Standardization in their standard [ISO 4400:1994](https://www.iso.org/standard/20509.html). Through bringing together experts in relevant fields, they develop and distribute the standard so producers of plugs

- There would be lots of different types of plugs, causing confusion and incompatability
- You wouldn't know if your plug is compatible with different charging points
- You wouldn't be able to share plugs with other people
- There wouldn't be a clear singular safety standard

What's the benefit of having this standard?
- Increases efficiency for companies producing plugs
- If a company follows the standard, they are likely to sell more products as people know they can use the product. If there was no standard, they would only be able to create a product that appeals to a smaller section of people
