...
After inputting the information into the fields, you can then select a machine readable format such as XML, HTML, XHTML to generate and save your metadata..
...
>[!NOTE]
> **KR TO DO:** Above is a completely fabricated example (need to complete) - we could use a real life example if we feel that would work better?<br>
...
The Advanced Generator also include seven further metadata elements.
This includes...
<img src="img/DCAd Gen additions.png" alt="Alt Text" width="240" height="400"> 

Using these extra features, try re-doing the metadata for the example research project.
