...
>[!NOTE]
>BO - I don't think we need "We will look at creating metadata to describe a research project as a whole (high-level metadata)." as it's repetitive of the second sentence in the first para. Suggest adding something to the second sentence in the first para to say we'll be looking at creating high-level metadata, then delete "We will look at creating metadata...".
...
## How can we produce high-quality, study-level metadata?

Thinking back to the previous units, what tools can we use to create study level metadata and implement best practice?
