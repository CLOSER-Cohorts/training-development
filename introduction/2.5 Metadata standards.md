...
Another thing to consider is whether this data would be deposited into a data repository or catalogue, as these platforms may specify or recommend a particular metadata standard to ensure that all projects that want to deposit data with them are using the same terms and structure. In this example, as it is a social science research project, we would need to find a leading social science data respoitory and/or catalogue. Thinking back to [unit 2.3](<2.3 Using metadata: Discover data.md>), you can use sites such as re3data.org or FAIRsharing.org to find relevant catalogues.
